# ===== Google GenAI를 활용한 고급 내전 관리 시스템 =====

# 1. 필요한 라이브러리 설치
!pip install -q google-genai requests pandas matplotlib seaborn plotly
...
def run_enhanced_demo():
    ...
    # API 키 입력
    riot_api_key = input("라이엇 API 키를 입력하세요: ").strip()
    genai_api_key = input("Google AI API 키를 입력하세요: ").strip()
